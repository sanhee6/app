<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="类型" prop="leixing" for="leixing">
          <el-input v-model="ruleForm.leixing" 
              placeholder="类型" clearable  :readonly="ro.leixing" id="leixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="类型" prop="leixing" for="leixing-info">
              <el-input v-model="ruleForm.leixing" 
                placeholder="类型" readonly id="leixing-info"></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
