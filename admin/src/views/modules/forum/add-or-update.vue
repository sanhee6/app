<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="帖子标题" prop="title" for="forum-title">
          <el-input v-model="ruleForm.title" 
              id="forum-title"
              placeholder="帖子标题" clearable  :readonly="ro.title"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="帖子标题" prop="title" for="forum-title-info">
              <el-input v-model="ruleForm.title" 
                id="forum-title-info"
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="状态" prop="isdone" for="forum-isdone">
          <el-select v-model="ruleForm.isdone" placeholder="请选择状态" id="forum-isdone">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="状态" prop="isdone" for="forum-isdone-info">
	      <el-input v-model="ruleForm.isdone"
                id="forum-isdone-info"
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'" label="帖子内容" prop="content" for="forum-content">
                <editor 
                    id="forum-content"
