<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="名称" prop="name" for="config-name">
          <el-input v-model="ruleForm.name" 
              id="config-name"
              placeholder="名称" clearable readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="名称" prop="name" for="config-name-info">
              <el-input v-model="ruleForm.name" 
                id="config-name-info"
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.value" label="值" prop="value" for="config-value">
          <file-upload
          id="config-value"
          tip="点击上传值"
          action="file/upload"
