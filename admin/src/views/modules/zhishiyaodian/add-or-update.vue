<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="知识点名" prop="zhishidianmingcheng" for="zhishidianmingcheng">
          <el-input v-model="ruleForm.zhishidianmingcheng" 
              id="zhishidianmingcheng"
              placeholder="知识点名" clearable  :readonly="ro.zhishidianmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="知识点名" prop="zhishidianmingcheng" for="zhishidianmingcheng-info">
              <el-input v-model="ruleForm.zhishidianmingcheng" 
                id="zhishidianmingcheng-info"
                placeholder="知识点名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.kechengtupian" label="课程图片" prop="kechengtupian" for="kechengtupian-upload">
          <file-upload
          id="kechengtupian-upload"
          tip="点击上传课程图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="发布日期" prop="faburiqi" for="faburiqi">
            <el-date-picker
                id="faburiqi"
                format="yyyy MM dd "
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.faburiqi" label="发布日期" prop="faburiqi" for="faburiqi-info">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="知识点内容" prop="zhishidianneirong" for="zhishidianneirong">
                <el-input
                  id="zhishidianneirong"
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'" label="知识点解析" prop="zhishidianjiexi" for="zhishidianjiexi">
                <editor 
                    id="zhishidianjiexi"
                    style="min-width: 200px; max-width: 600px;"
