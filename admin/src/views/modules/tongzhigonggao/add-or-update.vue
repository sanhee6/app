<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公告标题" prop="gonggaobiaoti" for="gonggaobiaoti">
          <el-input v-model="ruleForm.gonggaobiaoti" 
              placeholder="公告标题" clearable  :readonly="ro.gonggaobiaoti" id="gonggaobiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公告标题" prop="gonggaobiaoti" for="gonggaobiaoti-info">
              <el-input v-model="ruleForm.gonggaobiaoti" 
                placeholder="公告标题" readonly id="gonggaobiaoti-info"></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公告类型" prop="gonggaoleixing" for="gonggaoleixing">
          <el-input v-model="ruleForm.gonggaoleixing" 
              placeholder="公告类型" clearable  :readonly="ro.gonggaoleixing" id="gonggaoleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公告类型" prop="gonggaoleixing" for="gonggaoleixing-info">
              <el-input v-model="ruleForm.gonggaoleixing" 
                placeholder="公告类型" readonly id="gonggaoleixing-info"></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="发布时间" prop="fabushijian" for="fabushijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fabushijian" label="发布时间" prop="fabushijian" for="fabushijian-info">
              <el-input v-model="ruleForm.fabushijian" 
                placeholder="发布时间" readonly id="fabushijian-info"></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发布人" prop="faburen" for="faburen">
          <el-input v-model="ruleForm.faburen" 
              placeholder="发布人" clearable  :readonly="ro.faburen" id="faburen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发布人" prop="faburen" for="faburen-info">
              <el-input v-model="ruleForm.faburen" 
                placeholder="发布人" readonly id="faburen-info"></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.fengmian" label="封面" prop="fengmian" for="fengmian">
          <file-upload
          tip="点击上传封面"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="公告内容" prop="gonggaoneirong" for="gonggaoneirong">
                <editor 
...
export default {
  ...
  created() {
    console.log('通知公告添加/更新组件已创建');
	this.addEditStyleChange()
	this.addEditUploadStyleChange()
  },
  mounted() {
    console.log('通知公告添加/更新组件已挂载');
  },
  methods: {
    refreshComponent() {
      console.log('手动刷新组件');
