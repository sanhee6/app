     ...
     <el-row>
      <el-col :span="12">
        <el-form-item v-if="flag=='xueshengyonghu'" label="学号" prop="xuehao">
          <el-input id="xuehao" v-model="ruleForm.xuehao" readonly placeholder="学号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='xueshengyonghu'" label="学生姓名" prop="xueshengxingming">
          <el-input id="xueshengxingming" v-model="ruleForm.xueshengxingming" placeholder="学生姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='xueshengyonghu'" label="性别" prop="xingbie">
          <el-select id="xingbie-xueshengyonghu" v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='xueshengyonghu'" label="班级" prop="banji">
          <el-select id="banji" v-model="ruleForm.banji" placeholder="请选择班级">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='xueshengyonghu'" label="手机" prop="shouji">
          <el-input id="shouji" v-model="ruleForm.shouji" placeholder="手机" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='xueshengyonghu'" label="身份证" prop="shenfenzheng">
          <el-input id="shenfenzheng-xuesheng" v-model="ruleForm.shenfenzheng" placeholder="身份证" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='jiaoshiyonghu'" label="教师工号" prop="jiaoshigonghao">
          <el-input id="jiaoshigonghao" v-model="ruleForm.jiaoshigonghao" readonly placeholder="教师工号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='jiaoshiyonghu'" label="教师姓名" prop="jiaoshixingming">
          <el-input id="jiaoshixingming" v-model="ruleForm.jiaoshixingming" placeholder="教师姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='jiaoshiyonghu'" label="性别" prop="xingbie">
          <el-select id="xingbie-jiaoshiyonghu" v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='jiaoshiyonghu'" label="所教班级" prop="suojiaobanji">
          <el-select id="suojiaobanji" v-model="ruleForm.suojiaobanji" placeholder="请选择所教班级">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='jiaoshiyonghu'" label="所教科目" prop="suojiaokemu">
          <el-select id="suojiaokemu" v-model="ruleForm.suojiaokemu" placeholder="请选择所教科目">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='jiaoshiyonghu'" label="联系电话" prop="lianxidianhua">
          <el-input id="lianxidianhua" v-model="ruleForm.lianxidianhua" placeholder="联系电话" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='jiaoshiyonghu'" label="身份证" prop="shenfenzheng">
          <el-input id="shenfenzheng-jiaoshi" v-model="ruleForm.shenfenzheng" placeholder="身份证" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-form-item v-if="flag=='users'" label="用户名" prop="username">
        <el-input id="username" v-model="ruleForm.username" placeholder="用户名"></el-input>
      </el-form-item>
      <el-col :span="24">
      <el-form-item>
