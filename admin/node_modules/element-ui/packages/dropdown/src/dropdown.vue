<script>
  ...
  export default {
    ...
    methods: {
      ...
      resetTabindex(ele) { // 下次tab时组件聚焦元�?        this.removeTabindex();
        ele.setAttribute('tabindex', '0'); // 下次期望的聚焦元�?      },
      removeTabindex() {
      ...
      initAria() {
        ...
        if (!this.splitButton) { // 自定�?          this.triggerElm.setAttribute('role', 'button');
